...
COLUMNS = ["year1", "year2", "playerID", "outs_pitched", "earned_runs", "strike_outs_outs_pitched", 
			"walks_outs_pitched", "opponent_batting_avg", "league_batting_avg","earned_run_avg_year1", "earned_run_avg_year2"]

CONTINUOUS_COLUMNS = ["outs_pitched", "earned_runs", "strike_outs_outs_pitched", "walks_outs_pitched", "opponent_batting_avg",
...
def main():
	...
	m = tf.contrib.learn.LinearRegressor(feature_columns=[outs_pitched, earned_runs, strike_outs_outs_pitched,
			walks_outs_pitched, opponent_batting_avg, league_batting_avg, earned_run_avg_year1], 
